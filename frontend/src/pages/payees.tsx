            ...
            <TableHeader>
              <TableRow className="border-b border-border hover:bg-transparent">
                ...
                <TableHead
                  ...
                  className="hidden text-left text-xs font-medium text-muted-foreground py-3 w-[120px] sm:table-cell"
                >
                  <button
                    type="button"
            ...
            <TableBody>
              {pageItems.map((payee) => (
                ...
                >
                  ...
                  <TableCell className="max-w-0 w-full overflow-hidden py-2.5">
                    <span className="block truncate text-sm font-semibold text-foreground" title={payee.name}>{payee.name}</span>
                    {payee.notes && (
                      <p className="mt-0.5 truncate text-xs text-muted-foreground" title={payee.notes}>{payee.notes}</p>
                    )}
                  ...
                  <TableCell className="hidden py-2.5 text-left sm:table-cell">
