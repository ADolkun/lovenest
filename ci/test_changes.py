...
class CIChangesTest(unittest.TestCase):
    def setUp(self):
        ...
        for name in ("README.md", "docs/guide.md", "backend/old.py", "frontend/old.ts"):
    ...
    def test_component_docs_and_shared_paths(self):
        cases = [
            ({"README.md": "docs", "docs/new.md": "docs"}, ("false", "false")),
            ({"frontend/new.ts": "code"}, ("false", "true")),
            ({"backend/new.py": "code"}, ("true", "false")),
    ...
    def test_deleted_and_renamed_files(self):
        for old, new, expected in (
            ("backend/old.py", None, ("true", "false")),
            ("frontend/old.ts", None, ("false", "true")),
            ("backend/old.py", "docs/moved.md", ("true", "false")),
            ("frontend/old.ts", "docs/moved.md", ("false", "true")),
            ("backend/old.py", "frontend/moved.ts", ("true", "true")),
            ("docs/guide.md", "backend/moved.py", ("true", "false")),
        ):
    ...
    def test_checkout_depth_and_head_ref(self):
        self.merge({"README.md": "docs"})
        source = self.repo
        for depth, expected in ((2, ("false", "false")), (1, ("true", "true"))):
        ...
        self.select(("true", "true"), {"GITHUB_SHA": self.git("rev-parse", "HEAD")})
